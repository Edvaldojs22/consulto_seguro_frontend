            ...
            <form className="formVeiculo" >
                ...
                <section className="dadosBasico">
                    <div className="placaRenavm">
                        ...
                        <input type="text" id='campoPlaca' required placeholder='Placa :' />

                        <label htmlFor="campoRenavam">Renavam:</label>
                        <input type="text" id='campoRenavam' required placeholder='Renavam :' />
                    </div>

                    <div className="chassiAno">
                        <label htmlFor="campoChassi">Chassi:</label>
                        <input type="text" id='campoChassi' required placeholder='Chassi :' />
                    ...
                    <div className="propietarioDocument">
                        ...
                        <input type="text" id='campoProprietario' required placeholder='Proprietário :' />

                        <label htmlFor="campoDocumentacaoProprietario">Documentação Proprietário:</label>
                        <input type="text" id='campoDocumentacaoProprietario' required placeholder='Documentação :' />
                    </div>
                ...
                <section className="dadosVeiculo">
                    ...
                    <div className="marcaModelo">
                        ...
                        <input type="text" id='campoMarca' required placeholder='Marca:' />

                        <label htmlFor="campoModelo">Modelo:</label>
                        <input type="text" id='campoModelo' required placeholder='Modelo:' />
                    </div>

                    <label htmlFor="campoCombustivel">Combustivél:</label>
                    <input type="text" id='campoCombustivel' placeholder='Combustivél:' />
                    ...
                    <div className="caixa-money">
                        ...
                        <input type="text" id="campoValor" required placeholder="Ex: 00.00,00" />
                    </div>
