...
export default function AddContrato() {
  ...
  const handleInputChange2 = (event) => {
    ...
    const filteredVeiculos = listaVeiculos.filter((veiculo) =>
      veiculo.nome.toLowerCase().includes(value)
    );
        ...
        <form className="formContrato">
          ...
          <section className="dadosBasico">
            <div className="regionalVendedor">
              ...
              <input
                type="text"
                id="campoRegional"
                placeholder="AG - REGIONAL LEANDRO"
              />
            ...
            <div className="data-TipoContrato">
              ...
              <input
                type="date"
                name="campoInicioContrato"
                id="campoInicioContrato"
                required
              />

              <label htmlFor="campoRenovacaoContrato">
                Renovação do Contrato:
              </label>
              <input
                type="date"
                name="campoRenovacaoContrato"
                id="campoRenovacaoContrato"
                required
              />
              ...
              <div className="caixaClienteInpunt">
                <div className="caixaScrollCliente">
                  {suggestions2.map((veiculo, index) => (
                    <div
                      key={index}
                      onClick={() => handleOptionClick2(veiculo)}
                    >
                      <p>{veiculo.nome}</p>
                    </div>
                  ))}
          ...
          <section className="dadosValores">
            ...
            <select name="planos" id="campoPlanos" required>
              <option value=""></option>
              <option value="">
                AG - MOTOCICLETA (PLANO DIFERENCIADO) - De R$ 0,00 até R$
                40.000,00
              </option>
              <option value="">
                AG - MOTOCICLETAS PLANO BASICO 04 - 2022 - De R$ 6.000,01 até R$
                7.000,00
              </option>
              <option value="">
                AG - MOTOCICLETAS PLANO SLIM 04 - De R$ 6.000,01 até R$ 7.000,00
              </option>
              <option value="">
                AG - MOTOCICLETAS PLANO TOP 04 - 2022 - De R$ 6.000,01 até R$
                7.000,00
              </option>
              <option value="">
                PE - MOTOCICLETAS PLANO BASICO 04 - 2022 - De R$ 6.000,01 até R$
                7.000,00
              </option>
              <option value="">
                PE - MOTOCICLETAS PLANO SLIM 04 - 2022 - De R$ 6.000,01 até R$
                7.000,00
              </option>
              <option value="">
                PE - MOTOCICLETAS PLANO TOP 04 - 2022 - De R$ 6.000,01 até R$
                7.000,00
              </option>
              <option value="">
                PLANO PERSONALIZADO MOTO - De R$ 0,00 até R$ 100.000,00
              </option>
            </select>
            ...
            <div className="contaVencimentoModelo">
              ...
              <select
                name="modeloFinanceiro"
                id="campoModeloFinanceiro"
                required
              >
                <option value=""></option>
            ...
            <div className="valoresPCDM">
              ...
              <label htmlFor="campoCoberturasAdicionais">
                Coberturas Adicionais
              </label>
              <input
                type="text"
                name="CoberturasAdicionais"
                id="campoCoberturasAdicionais"
                placeholder="0,00"
              />

              <label htmlFor="campoDescontoMensalidade">
                Desconto da Mensalidade
              </label>
              <input
                type="text"
                name="DescontoMensalidade"
                id="campoDescontoMensalidade"
                placeholder="0,00"
              />

              <label htmlFor="campoValorMensalidade">
            ...
            <textarea
              name="ObservacaoCadastro"
              id="campoObservacaoCadastro"
            ></textarea>
          </section>
