      ...
      <div className="caixaForm">
        <form className="formAssociado">
          ...
          <section onClick={ativar} className="botoesValor">
            <div
              className={`botaoPessoa Física ${
                valorPessoa === "Física" ? "fisicaGreen" : ""
              }`}
            >
              <p>Física</p>
            </div>
            <div
              className={`botaoPessoa Juridíca ${
                valorPessoa === "Juridíca" ? "JuridícaGreen" : ""
              }`}
            >
              <p>Jurídica</p>
            </div>
          ...
          {valorPessoa === "Juridíca" && (
            <section className="dadosPessoasJ">
              ...
              <input
                ...
                required
                placeholder="Indentidade Responsavel :"
              />
